module deltotum.physics.particles.emitter;

import deltotum.toolkit.display.display_object : DisplayObject;
import deltotum.physics.particles.particle : Particle;
...
class Emitter : DisplayObject
{
    ...
    this(bool isActive = true, EmitterConfig config = null)
    {
        ...
        if (config is null)
        {
            import deltotum.physics.particles.config.json_emitter_config : JsonEmitterConfig;
