...
class Fractals : Control
{
    ...
    override void create()
    {
        ...
        import dm.addon.fractals.fractal_generator : FractalGenerator;
        ...
        import dm.addon.sprites.images.fractals.mandelbrot : Mandelbrot;
        ...
        import dm.addon.sprites.images.fractals.julia : Julia;

        auto julia = new Julia(shapeSize, shapeSize);
        container3.addCreate(createFractalInfo("Julia", julia, false));

        import dm.addon.sprites.images.fractals.newton : Newton;
