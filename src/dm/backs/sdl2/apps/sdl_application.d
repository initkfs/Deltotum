module dm.backs.sdl2.apps.sdl_application;
...
import dm.backs.sdl2.events.sdl_event_processor : SdlEventProcessor;
...
import dm.backs.sdl2.sdl_lib : SdlLib;
import dm.backs.sdl2.img.sdl_img_lib : SdlImgLib;
import dm.backs.sdl2.mix.sdl_mix_lib : SdlMixLib;
import dm.backs.sdl2.ttf.sdl_ttf_lib : SdlTTFLib;
import dm.backs.sdl2.sdl_window : SdlWindow;
import dm.backs.sdl2.sdl_window : SdlWindowMode;
import dm.backs.sdl2.sdl_renderer : SdlRenderer;
import dm.backs.sdl2.sdl_joystick : SdlJoystick;
import dm.kit.windows.events.window_event : WindowEvent;
import dm.kit.inputs.pointers.events.pointer_event : PointerEvent;
import dm.backs.sdl2.sdl_texture : SdlTexture;
import dm.backs.sdl2.sdl_surface : SdlSurface;
import dm.backs.sdl2.ttf.sdl_ttf_font : SdlTTFFont;
import dm.backs.sdl2.img.sdl_image : SdlImage;
...
class SdlApplication : ContinuouslyApplication
{
    ...
    override ApplicationExit initialize(string[] args)
    {
        ...
        import dm.backs.sdl2.sdl_cursor : SDLCursor;
        ...
        import dm.backs.sdl2.sdl_screen : SDLScreen;
