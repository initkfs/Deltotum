...
class Procedural : Control
{
    ...
    override void create()
    {
        ...
        import api.dm.kit.sprites.textures.vectors.tessellations.voderberg : Voderberg, ShapeType;
        ...
        // import api.dm.kit.sprites.textures.vectors.noises.samples.fractal_noise : FractalNoise;
        // import api.dm.kit.sprites.textures.vectors.noises.samples.voronoi : Voronoi;
        // import api.dm.kit.sprites.textures.vectors.noises.samples.value : Value;
        // import api.dm.kit.sprites.textures.vectors.noises.samples.worley : Worley;
        // import api.dm.kit.sprites.textures.vectors.noises.samples.simplex : Simplex;
        // import api.dm.kit.sprites.textures.vectors.noises.samples.perlin : SPerlin = Perlin;
        ...
        // import api.dm.kit.sprites.textures.vectors.noises.fractal_cell: FractalCell;
        ...
        import api.dm.kit.sprites.textures.vectors.mazes.binary_tree : BinaryTree;
        ...
        import api.dm.kit.sprites.textures.vectors.mazes.sidewinder : Sidewinder;
        ...
        import api.dm.kit.sprites.textures.vectors.mazes.aldous_broder : AldousBroder;
