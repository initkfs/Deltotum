...
import api.dm.sim3d.procedural.lsystems.textures.lshape : LShape;
import api.dm.sim3d.procedural.lsystems.lsystem : LSystemData;
import LFractals = api.dm.sim3d.procedural.fractals.lfractals;
...
class Fractals : Control
{
    ...
    override void create()
    {
        ...
        import api.dm.sim3d.procedural.fractals.images.mandelbrot : Mandelbrot;
        ...
        import api.dm.sim3d.procedural.fractals.images.julia : Julia;

        auto julia = new Julia(shapeSize, shapeSize);
        container3.addCreate(createFractalInfo("Julia", julia));

        import api.dm.sim3d.procedural.fractals.images.newton : Newton;
