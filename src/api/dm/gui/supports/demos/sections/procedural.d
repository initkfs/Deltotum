module api.dm.gui.supports.demos.sections.procedural;
...
class Procedural : Control
{
    ...
    {
        import api.dm.sims.procedural.tessellations.textures.penrose_tiling : PenroseTiling;
    ...
    {
        import api.dm.sims.procedural.cellulars.elementary_cellular : ElementaryCellular;
    ...
    {
        import api.dm.sims.procedural.mazes.shapes.binary_tree : BinaryTree;
        ...
        import api.dm.sims.procedural.mazes.shapes.sidewinder : Sidewinder;
        ...
        import api.dm.sims.procedural.mazes.shapes.aldous_broder : AldousBroder;
    ...
    void createNoise(Control noiseRoot)
    {
        ...
        import api.dm.sims.procedural.noises.textures.fractal_noise : FractalNoise;
        import api.dm.sims.procedural.noises.voronoi : Voronoi;
        import api.dm.sims.procedural.noises.value : Value;
        import api.dm.sims.procedural.noises.worley : Worley;
        import api.dm.sims.procedural.noises.simplex : Simplex;
        import api.dm.sims.procedural.noises.perlin : SPerlin = Perlin;
        import api.dm.sims.procedural.noises.textures.open_simplex : OpenSimplex;
        ...
        import api.dm.sims.procedural.noises.textures.perlin : Perlin;
