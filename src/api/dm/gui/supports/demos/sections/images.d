module api.dm.gui.supports.demos.sections.images;
...
class Images : Control
{
    ...
    override void create()
    {
        ...
        build(hist);
        hist.create(ColorProcessor.histogram(colorBuff));
        ...
        grayscaleThreshold.create(colorBuff);
        ...
        poster.create(colorBuff);
        container.addCreate(createImageInfo("Poster", poster));

        auto blend = new Image(imageWidth, imageHeight);
        build(blend);
        blend.create(ColorProcessor.blend(colorBuff, RGBA.blue, ColorProcessor.BlendMode.overlay));
        ...
        build(crop);
        crop.create(ColorProcessor.crop(colorBuff, Rect2f(10, 10, 50, 50)));
