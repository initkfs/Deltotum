module api.dm.addon.math.geom2.triangulations.delaunay;
...
bool isPointInCircumCircle(Triangle2d tr, Vec2d point) @nogc pure @safe
{
...
bool getNoneEdgeVertex(Triangle2d tr, Line2d edge, out Vec2d v) @nogc pure @safe
{
...
LineDistance findNearestEdge(Triangle2d tr, Vec2d point) @nogc pure @safe
{
...
Vec2d computeClosestPoint(Line2d edge, Vec2d point) @nogc pure @safe
{
    immutable Vec2d ab = edge.end.subtract(edge.start);
...
class TriangleStore
{
    ...
    Nullable!Triangle2d findContainingTriangle(Vec2d point)
    {
    ...
    Line2d findNearestEdge(Vec2d point)
    {
    ...
    void removeTriangles(Vec2d vertex)
    {
...
void legalizeEdge(TriangleStore triangles, Triangle2d triangle, Line2d edge, Vec2d newVertex)
{
...
public Triangle2d[] triangulate(Vec2d[] pointSet)
{
    ...
    Vec2d p1 = Vec2d(0.0, 3.0 * maxOfAnyCoordinate);
    Vec2d p2 = Vec2d(3.0 * maxOfAnyCoordinate, 0.0);
    Vec2d p3 = Vec2d(-3.0 * maxOfAnyCoordinate, -3.0 * maxOfAnyCoordinate);
    ...
    for (int i = 0; i < pointSet.length; i++)
    {
        ...
        if (mustBeTriangle.isNull)
        {
            ...
            Vec2d firstNoneEdgeVertex;
            Vec2d secondNoneEdgeVertex;
