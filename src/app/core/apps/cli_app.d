module app.core.apps.cli_app;

import app.core.components.units.simple_unit : SimpleUnit;
...
import app.core.clis.printers.cli_printer : CliPrinter;
...
import app.core.events.bus.event_bus : EventBus;
import app.core.events.bus.core_bus_events : CoreBusEvents;
import app.core.locators.service_locator : ServiceLocator;
import app.core.mem.allocator : Allocator;
import app.core.mem.mallocator : Mallocator;
import app.core.supports.errors.err_status : ErrStatus;

import CoreEnvKeys = app.core.core_env_keys;
...
class CliApp : SimpleUnit
{
    ...
    Config newConfigFromFile(string configFile)
    {
        ...
        import app.core.configs.properties.property_config : PropertyConfig;
    ...
    {
        import app.core.configs.config_aggregator : ConfigAggregator;
    ...
    {
        import app.core.configs.aa_const_config : AAConstConfig;
        ...
        string[] args)
    {
        ...
        import app.core.apps.crashes.file_crash_handler : FileCrashHandler;
