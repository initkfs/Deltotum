module app.dm.gui.supports.editors.sections.controls;
...
import app.dm.gui.containers.frame : Frame;
...
class Controls : Control
{
    ...
    void createButtons(Container root)
    {
        ...
        import app.dm.gui.controls.buttons.round_button : RoundButton;

        auto circleBtn = new RoundButton("Button");
        circleBtn.isBackground = true;
        root.addCreate(circleBtn);

        import app.dm.gui.controls.buttons.rhombus_button : RhombusButton;

        auto rhBtn = new RhombusButton("Button");
        //rhBtn.isBackground = true;
        root.addCreate(rhBtn);

        import app.dm.gui.controls.buttons.target_button : TargetButton;
    ...
    {
        import app.dm.gui.controls.checks.checkbox : CheckBox;
        import app.dm.gui.controls.choices.choice_box : ChoiceBox;

        import Icons = app.dm.kit.graphics.themes.icons.icon_name;

        import app.dm.gui.controls.labels.hyperlink: Hyperlink;
        ...
        import app.dm.gui.controls.labels.badge: Badge;
        ...
        import app.dm.gui.controls.toggles.toggle_switch : ToggleSwitch;
        ...
        import app.dm.gui.controls.spinners.spinner : Spinner;

        auto spinner1 = new Spinner!int;
        root.addCreate(spinner1);

        import app.dm.gui.controls.pickers.color_picker : ColorPicker;
    ...
    {
        import app.dm.gui.controls.separators.vseparator : VSeparator;
    ...
    void createDataControls(Container rootContainer)
    {
        ...
        import app.dm.gui.controls.trees.tree_list_view : TreeListView;
        import app.dm.gui.controls.trees.tree_item : TreeItem;
        ...
        // import app.dm.gui.controls.datetimes.calendar : Calendar;

        // auto cal1 = new Calendar;
        // rootContainer.addCreate(cal1);

        // import app.dm.gui.controls.pickers.time_picker : TimePicker;

        // auto time1 = new TimePicker;
        // rootContainer.addCreate(time1);

        import app.dm.gui.controls.clocks.analog_clock: AnalogClock;
    ...
    {
        import app.dm.gui.controls.charts.linear_chart : LinearChart;
    ...
    private void createWindows(Container root)
    {
        import app.dm.gui.controls.buttons.button : Button;
        import app.dm.gui.controls.checks.checkbox : CheckBox;
        import IconName = app.dm.kit.graphics.themes.icons.icon_name;
    ...
    private void createTexts(Container root)
    {
        ...
        import app.dm.gui.controls.expanders.expander : Expander, ExpanderPosition;
    ...
    {
        import app.dm.gui.controls.progress.radial_progress_bar : RadialProgressBar;
        ...
        import app.dm.gui.controls.gauges.hlinear_gauge : HLinearGauge;
