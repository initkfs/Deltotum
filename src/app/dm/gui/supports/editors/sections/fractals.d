module app.dm.gui.supports.editors.sections.fractals;
...
class Fractals : Control
{
    ...
    override void create()
    {
        ...
        import app.dm.addon.fractals.fractal_generator : FractalGenerator;
        ...
        import app.dm.addon.sprites.images.fractals.mandelbrot : Mandelbrot;
        ...
        import app.dm.addon.sprites.images.fractals.julia : Julia;

        auto julia = new Julia(shapeSize, shapeSize);
        container3.addCreate(createFractalInfo("Julia", julia, false));

        import app.dm.addon.sprites.images.fractals.newton : Newton;
