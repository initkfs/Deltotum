module app.dm.gui.supports.editors.sections.indicators;
...
class Indicators : Control
{
    ...
    {
        import app.dm.addon.gui.controls.indicators.seven_segment : SevenSegment;
        ...
        import app.dm.addon.gui.controls.indicators.dot_matrix_display : DotMatrixDisplay;
        ...
        import app.dm.addon.gui.controls.indicators.gauges.gauge : Gauge;

        auto g1 = new Gauge;
        root.addCreate(g1);

        import app.dm.addon.gui.controls.indicators.leds.led : Led;
        ...
        import app.dm.addon.gui.controls.indicators.leds.led_icon : LedIcon;
        import IconNames = app.dm.kit.graphics.themes.icons.icon_name;
