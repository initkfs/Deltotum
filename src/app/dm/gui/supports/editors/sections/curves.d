module app.dm.gui.supports.editors.sections.curves;
...
class Curves : Control
{
    ...
    Sprite createCurveInfo(string name, Vector2[] points, bool isDrawFromCenter = true, bool isClosePath = false)
    {
        ...
        {
            import app.dm.kit.sprites.textures.vectors.shapes.vpoints_shape: VPointsShape;

            shape = new VPointsShape(points, shapeSize, shapeSize, shapeStyle, isClosePath, isDrawFromCenter);
        }
        else
        {
            import app.dm.kit.sprites.shapes.points_shape : PointsShape;
    ...
    override void create()
    {
        ...
        import app.dm.addon.math.curves.spirals : Spirals;
        ...
        import app.dm.addon.math.curves.plane_curves : PlaneCurve;
        ...
        import app.dm.addon.math.curves.cubic_plane_curves : CubicPlaneCurves;
        ...
        import app.dm.addon.math.curves.superellipse : Superellipse;
        ...
        import app.dm.addon.math.curves.roses : Roses;
        ...
        import app.dm.addon.math.curves.cycloidal : Cycloidal;
        ...
        import app.dm.addon.math.curves.lissajous : Lissajous;
