module app.dm.gui.supports.editors.sections.procedural;
...
import app.dm.kit.sprites.transitions.pause_transition : PauseTransition;
import app.dm.math.random : Random;
import app.dm.kit.sprites.textures.vectors.tessellations.penrose_tiling : PenroseTiling;
...
class Procedural : Control
{
    ...
    override void create()
    {
        ...
        import app.dm.kit.sprites.textures.vectors.tessellations.voderberg : Voderberg, ShapeType;
        ...
        import app.dm.kit.sprites.textures.vectors.noises.perlin : Perlin;
        import app.dm.kit.sprites.textures.vectors.noises.open_simplex : OpenSimplex;
        import app.dm.kit.sprites.transitions.pause_transition : PauseTransition;
        import app.dm.math.random : Random;
        ...
        // import app.dm.kit.sprites.textures.vectors.noises.samples.fractal_noise : FractalNoise;
        // import app.dm.kit.sprites.textures.vectors.noises.samples.voronoi : Voronoi;
        // import app.dm.kit.sprites.textures.vectors.noises.samples.value : Value;
        // import app.dm.kit.sprites.textures.vectors.noises.samples.worley : Worley;
        // import app.dm.kit.sprites.textures.vectors.noises.samples.simplex : Simplex;
        // import app.dm.kit.sprites.textures.vectors.noises.samples.perlin : SPerlin = Perlin;
        ...
        // import app.dm.kit.sprites.textures.vectors.noises.fractal_cell: FractalCell;
        ...
        import app.dm.kit.sprites.textures.vectors.mazes.binary_tree : BinaryTree;
        ...
        import app.dm.kit.sprites.textures.vectors.mazes.sidewinder : Sidewinder;
        ...
        import app.dm.kit.sprites.textures.vectors.mazes.aldous_broder : AldousBroder;
