module app.dm.kit.apps.graphic_application;
...
import app.dm.kit.i18n.langs.lang_messages : LangMessages;
...
abstract class GraphicApplication : CliApp
{
    ...
    I18n createI18n(Logger logger, Config config, Context context)
    {
        ...
        import app.dm.kit.i18n.langs.configs.simple_config_loader : SimpleConfigLoader;
        import KitConfigKeys = app.dm.kit.kit_config_keys;
    ...
    Theme createTheme(Logger logger, Config config, Context context, Resource resource)
    {
        ...
        import app.dm.kit.graphics.themes.theme : Theme;
        import app.dm.kit.graphics.themes.factories.theme_from_config_factory : ThemeFromConfigFactory;
    ...
    {
        import app.dm.kit.i18n.langs.alphabets.alphabet_ru : AlphabetRu;
        import app.dm.kit.i18n.langs.alphabets.en : AlphabetEn;
        import app.dm.kit.i18n.langs.alphabets.arabic_num_alphabet : ArabicNumAlpabet;
        import app.dm.kit.i18n.langs.alphabets.special_alphabet : SpecialAlphabet;
    ...
    {
        import app.dm.kit.i18n.langs.alphabets.arabic_num_alphabet : ArabicNumAlpabet;
        import app.dm.kit.i18n.langs.alphabets.light_special_alphabet : LightSpecialAlphabet;
