module app.dm.kit.sprites.sprite;

import app.dm.kit.events.event_kit_target : EventKitTarget;
...
import app.dm.kit.sprites.textures.rgba_texture : RgbaTexture;
import app.dm.kit.scenes.scaling.scale_mode : ScaleMode;
...
class Sprite : EventKitTarget
{
    ...
    {
        import app.dm.kit.graphics.contexts.renderer_graphics_context : RendererGraphicsContext;
    ...
    {
        import app.core.utils.arrays : drop;
